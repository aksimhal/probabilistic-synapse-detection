...
listOfMatFiles = {...
    '/data/anish/Synaptome/silane/labelVol', ...
    '/data/anish/Synaptome/silane/results/resultVol_5', ...
    '/data/anish/Synaptome/silane/probVolumes/prob_PSD95_488',...
    '/data/anish/Synaptome/silane/probVolumes/prob_Synapsin647', ...
    '/data/anish/Synaptome/silane/probVolumes/prob_VGluT1_647', ...
    '/data/anish/Synaptome/silane/probVolumes/prob_NR1594', ...
    '/data/anish/Synaptome/silane/rawVolumes/EM25K'};

% Organize CC

load('/data/anish/Synaptome/silane/silaneLabels');
CC_labels = CC;
load('/data/anish/Synaptome/silane/silane_results');
